...
class Question7Fragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        view.findViewById<Button>(R.id.categoryBtn).setOnClickListener {
            it.findNavController().navigate(R.id.action_question7Fragment_to_categoryFragment)
        }

        view.findViewById<Button>(R.id.randomBtn).setOnClickListener {
            it.findNavController().navigate(R.id.action_question7Fragment_to_randomFragment)
        }

        view.findViewById<Button>(R.id.oilBtn).setOnClickListener {
            it.findNavController().navigate(R.id.action_question7Fragment_to_question8Fragment)
        }
